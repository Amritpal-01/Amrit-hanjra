...
const Navbar = () => {
  ...
  return (
    <div className='z-50 fixed top-0 left-0 w-dvw flex justify-center julius overflow-hidden'>
        <div className='max-w-7xl w-full p-4 flex justify-between items-center'>
            ...
            <ul className='lg:flex items-center gap-4 hidden'>
                ...
                <a className='text-md px-4 py-2 rounded-full hover:bg-gray-400/50 cursor-pointer transition-all duration-300'>Contact Us</a>
            </ul>
        </div>
    </div>
  )
